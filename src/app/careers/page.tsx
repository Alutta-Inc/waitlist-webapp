...
export default async function CareersPage() {
 ...
 return <div className="atlas-home careers-home">
  ...
  <section className="careers-hero atlas-container" aria-labelledby="careers-heading">
   <div className="careers-hero-copy"><span className="careers-kicker"><span /> CAREERS AT ALUTTA</span><h1 id="careers-heading">Build something<br />that takes people<br /><em>places.</em></h1><p>Big dreams deserve a clear path. Help us make studying, moving, and starting a new life abroad feel a little more possible.</p><div className="careers-hero-actions"><a href="#roles" className="atlas-button" data-track="careers-see-roles">Find your next role <ArrowUpRight size={20} /></a><a href="#our-purpose" className="careers-link">Meet the mission <ArrowDown size={18} /></a></div><span className="careers-hero-footnote">Your next chapter could change someone else’s.</span></div>
  ...
  <section className="careers-closing atlas-container"><Globe2 size={38} aria-hidden="true"/><h2>Big dreams need<br /><em>thoughtful people.</em></h2><p>There’s a whole world ahead. Let’s make it easier to reach.</p><a href="#roles" className="atlas-button lime" data-track="careers-see-roles">Explore opportunities <ArrowUpRight size={21}/></a><span className="careers-closing-orbit" aria-hidden="true"/></section>
  <CareersFooter />
 </div>;
}
