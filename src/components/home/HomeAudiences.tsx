...
const audiences = [
  { Icon: GraduationCap, tag: "FOR STUDENTS", title: "One profile, every application", body: "Build your profile once. Use it for every school and every award you apply to, then for everything that comes after.", cta: "Join the waitlist", href: "/waitlist", track: "join-audience" },
  { Icon: Landmark, tag: "FOR INSTITUTIONS", title: "One step away, not one more form", body: "Students apply to you with the profile they have already built. Complete applications, free to join, and you decide every one.", cta: "See how a partnership works", href: "/institutions", track: "pack-institutions" },
  { Icon: HandCoins, tag: "FOR FUNDING BODIES", title: "Your awards, in front of the right students", body: "Scholarships and grants shown to the students they were made for, at the moment they are planning how to pay.", cta: "See how funders work with us", href: "/funding-bodies", track: "pack-funders" },
];

export default function HomeAudiences({ nigeria = false }: { nigeria?: boolean }) {
  return (
    <section className="audiences" aria-labelledby="audiences-heading" data-track-view="seen-audiences">
      <div className="audiences-inner">
        ...
        <div className="audiences-grid">
          {audiences.map(({ Icon, tag, title, body, cta, href, track }) => (
            <Link key={tag} className="audience-card" href={nigeria && href === "/waitlist" ? "/ng/waitlist" : href} data-track={track}>
